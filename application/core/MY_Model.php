...
class MY_Model extends CI_Model {
	...
	function page2($jml='', $perhalaman='' ,$hal=''){
            // jumlah data yang akan ditampilkan per halaman        
        $dataPerhalaman = $perhalaman;
        $showhalaman = 0;
        $nohalaman = 0;
        ...
        $output = '<div class="paginations-v3"><ul class="paginations-v3-list">';
        // menampilkan link previous
        if ($nohalaman > 1){
            ...
            $query = http_build_query($params);        
            $output .= '<li class="previous"><a href="?'.$query.'" aria-label="Previous"><span aria-hidden="true"><i class="fa fa-angle-double-left"></i></span></a></li>';
        } else {        
            $output .= '<li class="previous"><a href="#" aria-label="Previous"><span aria-hidden="true"><i class="fa fa-angle-double-left"></i></span></a></li>';
        }
        ...
        if ($nohalaman < $jumhalaman){ 
            ...
            $query = http_build_query($params);
            $output .= '<li class="next"><a href="?'.($query).'" aria-label="Next"><span aria-hidden="true"><i class="fa fa-angle-double-right"></i></span></a></li>';            
        } else {
			$output .= '<li class="next"><a href="#" aria-label="Next"><span aria-hidden="true"><i class="fa fa-angle-double-right"></i></span></a></li>';
		}
