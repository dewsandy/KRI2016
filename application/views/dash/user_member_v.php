                ...
                <tbody>
                  ...
                  ?>">
                    ...
                    <td>
                      ...
                      <a href="<?=base_url('dash');?>/user/active/<?=$data->id_user;?>/member" type="button" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Aktifkan</a>
					  <?php } else { ?>
                      <a href="<?=base_url('dash');?>/user/banned/<?=$data->id_user;?>/member" type="button" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> Banned</a>
					  <?php } ?>
                      <!-- <a href="<?=base_url('dash');?>/user/edit/<?=$data->id_user;?>" type="button" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> Edit</a>-->
                      <a href="<?=base_url('dash');?>/user/del/<?=$data->id_user;?>/member" type="button" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Hapus</a>
                    </td>                    
                  </tr>
                  <?php } ?>
                </tbody>
