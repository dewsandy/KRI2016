              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?=base_url('dash')?>/berita/edit/<?=$data->id_berita;?>" type="button" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> Edit</a>
                      <a href="<?=base_url('dash')?>/berita/delete/<?=$data->id_berita;?>" type="button" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Hapus</a>
                      <a href="<?=base_url('dash')?>/berita/view/<?=$data->id_berita;?>" type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Lihat</a>
                    </td>                              
                  </tr>
                  <?php } ?>
                </tbody>
